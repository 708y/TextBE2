...
public class BttDebugValue extends org.be.textbe.bttrace.resource.btt.debug.BttDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public BttDebugValue(org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
