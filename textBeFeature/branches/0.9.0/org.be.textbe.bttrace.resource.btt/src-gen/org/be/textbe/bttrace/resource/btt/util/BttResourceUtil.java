...
public class BttResourceUtil {
	...
	public static org.be.textbe.bttrace.resource.btt.mopp.BttResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.be.textbe.bttrace.resource.btt.mopp.BttResource) csResource;
	}
	
	public static org.be.textbe.bttrace.resource.btt.mopp.BttResource getResource(java.io.File file) {
	...
	public static org.be.textbe.bttrace.resource.btt.mopp.BttResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.be.textbe.bttrace.resource.btt.mopp.BttResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.be.textbe.bttrace.TextBTTrace getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.be.textbe.bttrace.TextBTTrace getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.be.textbe.bttrace.TextBTTrace) root;
	}
