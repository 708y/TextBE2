...
public class BttStackFrame extends org.be.textbe.bttrace.resource.btt.debug.BttDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget target;
	private String name;
	private int id;
	...
	public BttStackFrame(org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.be.textbe.bttrace.resource.btt.util.BttStringUtil.decode(data, ',');
	...
	private org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.be.textbe.bttrace.resource.btt.debug.BttStackFrame other = (org.be.textbe.bttrace.resource.btt.debug.BttStackFrame) obj;
		if (name == null) {
