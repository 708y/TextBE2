 ...
 */
public interface IBttOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation().getResourcePostProcessorProviderOptionKey();
