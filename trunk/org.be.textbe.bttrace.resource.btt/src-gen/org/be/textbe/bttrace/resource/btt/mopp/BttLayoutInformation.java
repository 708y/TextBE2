...
/**
 * A BttLayoutInformation is used to store layout information that is found while
 ...
 * BttLayoutInformations are aggregated in LayoutInformationAdapters. One
 * BttLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class BttLayoutInformation {
	
	private final org.be.textbe.bttrace.resource.btt.grammar.BttSyntaxElement syntaxElement;
	...
	public BttLayoutInformation(org.be.textbe.bttrace.resource.btt.grammar.BttSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.be.textbe.bttrace.resource.btt.grammar.BttSyntaxElement getSyntaxElement() {
