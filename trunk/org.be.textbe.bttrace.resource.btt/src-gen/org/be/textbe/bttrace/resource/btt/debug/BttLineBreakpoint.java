...
public class BttLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.be.textbe.bttrace.resource.btt.debug.lineBreakpoint.marker";
	
	public BttLineBreakpoint() {
		super();
	}
	
	public BttLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget target) {
		try {
	...
	public void remove(org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
