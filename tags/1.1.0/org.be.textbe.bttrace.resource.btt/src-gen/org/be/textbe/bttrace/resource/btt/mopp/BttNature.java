...
public class BttNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.be.textbe.bttrace.resource.btt.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.be.textbe.bttrace.resource.btt.mopp.BttBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.be.textbe.bttrace.resource.btt.mopp.BttBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
