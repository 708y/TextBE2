 ...
 */
public class BttEnumerationTerminal extends org.be.textbe.bttrace.resource.btt.grammar.BttTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public BttEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.be.textbe.bttrace.resource.btt.grammar.BttCardinality cardinality, int mandatoryOccurrencesAfter) {
