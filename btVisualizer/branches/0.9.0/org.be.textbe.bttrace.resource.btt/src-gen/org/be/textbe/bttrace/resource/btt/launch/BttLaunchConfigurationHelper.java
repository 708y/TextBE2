 ...
 * 
 */
package org.be.textbe.bttrace.resource.btt.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class BttLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends org.be.textbe.bttrace.resource.btt.util.AbstractBttInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, org.be.textbe.bttrace.resource.btt.util.AbstractBttInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final org.be.textbe.bttrace.resource.btt.debug.BttDebuggableInterpreter<ResultType, ContextType> interpreter = new org.be.textbe.bttrace.resource.btt.debug.BttDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		org.be.textbe.bttrace.resource.btt.debug.BttDebuggerListener<ResultType, ContextType> debugListener = new org.be.textbe.bttrace.resource.btt.debug.BttDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		org.be.textbe.bttrace.resource.btt.debug.BttDebugProcess process = new org.be.textbe.bttrace.resource.btt.debug.BttDebugProcess(launch);
		launch.addDebugTarget(new org.be.textbe.bttrace.resource.btt.debug.BttDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(org.be.textbe.bttrace.resource.btt.launch.BttLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.be.textbe.bttrace.resource.btt.util.BttResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, org.be.textbe.bttrace.resource.btt.mopp.BttPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
