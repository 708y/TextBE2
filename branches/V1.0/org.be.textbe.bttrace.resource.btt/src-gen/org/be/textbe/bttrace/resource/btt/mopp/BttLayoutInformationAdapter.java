...
/**
 * A BttLayoutInformationAdapter is used to store layout information that is found
 ...
 * BttLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class BttLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.be.textbe.bttrace.resource.btt.mopp.BttLayoutInformation> layoutInformations = new java.util.ArrayList<org.be.textbe.bttrace.resource.btt.mopp.BttLayoutInformation>();
	...
	public java.util.List<org.be.textbe.bttrace.resource.btt.mopp.BttLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.be.textbe.bttrace.resource.btt.mopp.BttLayoutInformation layoutInformation) {
