 ...
 */
public class BttPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.be.textbe.bttrace.resource.btt";
	/**
	...
	private static BttPlugin plugin;
	...
	public static BttPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BttPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, BttPlugin.PLUGIN_ID, message);
		}
		final BttPlugin pluginInstance = BttPlugin.getDefault();
