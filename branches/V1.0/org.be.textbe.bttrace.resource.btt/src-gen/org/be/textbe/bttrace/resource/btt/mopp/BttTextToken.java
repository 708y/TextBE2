...
public class BttTextToken implements org.be.textbe.bttrace.resource.btt.IBttTextToken {
	
	private final org.be.textbe.bttrace.resource.btt.IBttMetaInformation metaInformation = new org.be.textbe.bttrace.resource.btt.mopp.BttMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public BttTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
