 ...
 */
public class BttDefaultTokenResolver implements org.be.textbe.bttrace.resource.btt.IBttTokenResolver {
	 ...
	 */
	public BttDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public BttDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.be.textbe.bttrace.resource.btt.IBttTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.be.textbe.bttrace.resource.btt.grammar.BttGrammarInformationProvider.INSTANCE.getKeywords()) {
