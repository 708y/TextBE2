 ...
 */
public class BttMinimalModelHelper {
	
	private final static org.be.textbe.bttrace.resource.btt.util.BttEClassUtil eClassUtil = new org.be.textbe.bttrace.resource.btt.util.BttEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.be.textbe.bttrace.resource.btt.util.BttStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.be.textbe.bttrace.resource.btt.util.BttListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.be.textbe.bttrace.resource.btt.util.BttStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.be.textbe.bttrace.resource.btt.util.BttListUtil.castListUnchecked(value);
